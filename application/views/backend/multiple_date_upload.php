                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <div class="card-title"><i class="fa fa-file-excel"></i> Durational Transactions Dump</div>
							...
							<?php echo form_open_multipart(base_url('backend/admin/range_import'), ['id' => 'excel_form', 'class' => 'form-horizontal']); ?>
