                                    ...
                                    <div class="col-md-3">
                                        <div class="card card-profile">
                                            ...
                                            <div class="card-footer">
                                                <div align="center"><a href="<?php echo base_url('backend/admin/client_records/')?><?php echo $member->id;?>" class="btn btn-primary btn-rounded btn-sm"><i class="fa fa-dollar"></i><i class="fa fa-dollar"></i> Tollway Spending Details</a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
