                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <div class="card-title"><i class="fa fa-plus-circle"></i> New Client Registration</div>
                                    <div class="card-tools">
                                        <a href="<?php echo base_url('clients') ?>" class="btn btn-info btn-border btn-round btn-sm mr-2">
                                            View Clients
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div id="msg"><?php echo $this->session->flashdata('message'); ?></div>
						   		 <?php echo form_open_multipart('add-client', ['class' => 'form-horizontal', 'id' => 'new_client', 'method' => 'POST']);?>
							    	<div class="row">
									    <div class="col-md-6">
									    	<div class="text-center text-muted"><strong>Company Details</strong> <br /><hr /></div>
									    	<div class="form-group">
									    		<input name="company" value="<?php echo set_value('company')?>" placeholder="Company Name" class="form-control input-sm" type="text" />
									    	...
									    	<div class="form-group">
									    		<input name="company_phone" value="<?php echo set_value('company_phone')?>" placeholder="Company Phone" class="form-control input-sm" type="text" />
									    	...
									    	<div class="form-group">
									    		<select name="demo_acc" class="form-control input-sm">
									    			...
									    			<option value="0">Production account</option>
									    		</select>
									    		<span class="help_block"><?php echo form_error('demo_acc')?></span>
									    	</div>	
									    </div>
									    <div class="col-md-6">
									    	<div class="text-center text-muted"><strong>Contact Person [system admin]</strong> <br /><hr ></div>
											    <div class="form-group">
											    	<div class="row">
											    		<div class="col-md-6">
								    ...
								    <div class="col-md-6 ml-auto mr-auto text-center">
						    			<div class="form-group" style="margin-top: 10px;">
						    				<button type="submit" class="btn btn-sm btn-block btn-primary"><strong><i class="fa fa-save"></i> Save Client &amp; User</strong></button>
						    			</div>
						    		</div>
						    <?php echo form_close()?>
                            </div>
